...
<template>
  <div class="mb-6 space-y-4">
    ...
    <div v-if="internalFilters._toggle" class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="flex items-end">
          <label class="inline-flex items-center space-x-2 text-sm text-gray-700">
            <input type="checkbox" v-model="internalFilters.starredOnly" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
